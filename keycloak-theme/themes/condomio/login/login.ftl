...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#if section = "header">
        <span class="condomio-login-header">
            <span class="condomio-login-brand">
                <span class="condomio-login-brand-text">${msg("loginTitleHtml")}</span>
            </span>
            <span class="condomio-login-subtitle">${msg("loginAccountTitle")}</span>
        </span>
    <#elseif section = "form">
        <div id="kc-form">
