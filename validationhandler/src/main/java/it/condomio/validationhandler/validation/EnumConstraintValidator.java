...
public class EnumConstraintValidator implements ConstraintValidator<it.condomio.validationhandler.validation.Enum, String> {

    private Set<String> allowedValues;

    @Override
    public void initialize(it.condomio.validationhandler.validation.Enum constraintAnnotation) {
