...
/// Provider anagrafica condomini.
///
/// In questa fase i dati sono fittizi/statici, ma il contratto resta uguale
/// anche quando la sorgente diventera' API/database.
final condominiProvider = Provider<List<Condomino>>((ref) {
  return const [
    Condomino(
      id: 'C001',
      nome: 'Luca',
