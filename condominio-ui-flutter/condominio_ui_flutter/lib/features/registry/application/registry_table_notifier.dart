...
import 'condomini_notifier.dart';
import '../presentation/widgets/registry_types.dart';
...
/// Lista anagrafica derivata (filtro + sorting) in provider memoizzato.
///
/// Vantaggi:
/// - la trasformazione dati non resta nel build widget
/// - la home non deve osservare direttamente `condominiProvider`
/// - rebuild confinati ai consumer che usano questa derivazione
